                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body with-nav-tabs">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#expiring" data-toggle="tab">{{ @trans('custom.expiring') }}<span
                                                class="label label-warning margin-left-5">{{ $expiringCount }}</span></a></li>
                                <li><a href="#expired" data-toggle="tab">{{ @trans('custom.expired') }}<span class="label label-danger margin-left-5">{{ $expiredCount }}</span></a>
                                </li>
                                <li><a href="#birthdays" data-toggle="tab">{{ @trans('custom.birthdays') }}<span class="label label-success margin-left-5">{{ $birthdayCount }}</span></a>
                                </li>
                                <li><a href="#recent" data-toggle="tab">{{ @trans('custom.recent') }}</a></li>
                            </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="panel">
                        ...
                        <div class="panel-body with-nav-tabs">
                            <!-- Tabs Heads -->
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#due" data-toggle="tab">{{ @trans('custom.due') }}</a></li>
                                <li><a href="#outstanding" data-toggle="tab"> <span class="text-warning"> <i class="fa fa-exclamation-circle"></i> </span>{{ @trans('custom.outstanding') }}</a></li>
                            </ul>
                ...
                <div class="col-lg-6">
                    <div class="panel bg-white">
                        <div class="panel-title">
                            <div class="panel-head"> {{ @trans('custom.members_per_plan') }} </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="panel bg-white">
                        <div class="panel-title bg-transparent no-border">
                            <div class="panel-head"> {{ @trans('custom.registration_trend') }} </div>
                        </div>
