...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            {!! Form::label('due_date',@trans('custom.Due_date / Payment_date')) !!}
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
        {!! Form::label('repeat',@trans('custom.repeat')) !!}
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            {!! Form::label('note',@trans('custom.note')) !!}
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            {!! Form::label('amount',@trans('custom.amount')) !!}
