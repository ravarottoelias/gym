    ...
    <div class="col-md-12">
        <div class="panel no-border">
            <div class="panel-title">
                <div class="panel-head font-size-20">{{ @trans('custom.enter_details_invoice') }}</div>
            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('invoice_number', @trans('custom.invoice_number')) !!}
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('additional_fees', @trans('custom.additional_fee')) !!}
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('subscription_amount', @trans('custom.subscription_fee')) !!}
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-usd"></i></div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('taxes_amount',sprintf( @trans('custom.tax') . ' @ %s %%',Utilities::getSetting('taxes'))) !!}
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-usd"></i></div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            {!! Form::label('discount_percent', @trans('custom.discount')) !!}
                            <?php
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            {!! Form::label('discount_amount', @trans('custom.discount_amount')) !!}
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-usd"></i></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            {!! Form::label('discount_note', @trans('custom.discount_note')) !!}
