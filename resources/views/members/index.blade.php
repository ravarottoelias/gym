...
@section('content')
    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height"> {{ @trans('custom.members') }}
                @permission(['manage-gymie','manage-members','add-member'])
                <a href="{{ action('MembersController@create') }}" class="page-head-btn btn-sm btn-primary active" role="button">{{ @trans('custom.add_new') }}</a>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">{{ @trans('custom.total_members') }}</small>
            </h1>
            @endpermission
            @endpermission
        </div><!-- / PageHead -->
                                ...
                                <div class="row">
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            {!! Form::label('member-daterangepicker', @trans('custom.date_range')) !!}
                        ...
                        <div class="panel-body bg-white">
                            ...
                            @else
                                ...
                                <table id="members" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th>{{ @trans('custom.photo') }}</th>
                                        <th>{{ @trans('custom.code') }}</th>
                                        <th>{{ @trans('custom.name') }}</th>
                                        <th>{{ @trans('custom.phone') }}</th>
                                        <th>{{ @trans('custom.plan_name') }}</th>
                                        <th>{{ @trans('custom.member_start_at') }}</th>
