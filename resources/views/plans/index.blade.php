...
@section('content')
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">{{  @trans('custom.plans') }}
                        ...
                        <div class="panel-body no-padding-top bg-white">
                            ...
                            @else
                                ...
                                <table id="plans" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th>{{ @trans('custom.plan_code') }}</th>
                                        <th>{{ @trans('custom.plan_name') }}</th>
                                        <th>{{ @trans('custom.service_name') }}</th>
                                        <th>{{ @trans('custom.plan_details') }}</th>
                                        <th>{{ @trans('custom.days') }}</th>
