...
@section('content')
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">{{  @trans('custom.services') }}
                        ...
                        <div class="panel-body no-padding-top bg-white">
                            ...
                            @else
                                ...
                                <table id="services" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th class="text-center">{{ @trans('custom.service_name') }}</th>
                                        <th class="text-center">{{ @trans('custom.service_description') }}</th>
